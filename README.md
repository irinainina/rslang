...
- мини-игры – приложение Lingualeo `https://lingualeo.com/ru/training`. Бесплатный доступ к Lingualeo Premium откроется после 5 дней тренировки.
...
- **Изучение новых слов +110**
  - в настройках приложения пользователь может [указать](https://s8.hostingkartinok.com/uploads/images/2020/03/d0abe3023033e625754fcfbae5368dbf.png) количество новых слов, которые планирует выучивать за день а также максимальное количество просмотров карточек, которое задаёт лимит карточек на день. Это число не будет превышено, даже если в колоде есть карточки, ожидающие повторения. Когда дневная норма выполнена, об этом выводится [уведомление](https://s8.hostingkartinok.com/uploads/images/2020/03/6d81d7286f579309cea93842a746182f.png) +10
...
- **Реализация методики интервального повторения +60**  
  ...
  - на промо-странице приложения присутствует описание набора правил, по которым определяется интервал, через который будет вновь показана карточка с изучаемым словом. При составлении этих правил можно ориентироваться на [настройки](https://englishteacup.org/slovarnyj_zapas/programma-anki-nastrojka-kolod) карточек Anki, внося в них свои коррективы. Правила интервального повторения выглядят разумными и логичными, в ходе проверки не выявлено расхождения работы приложения с указанными правиламм +10
